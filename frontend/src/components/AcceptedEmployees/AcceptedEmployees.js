      ...
      <div className="AcceptedEmployees">
        <div className="FilterPanel">
          ...
          >
            ...
            <MenuItem value="title">Titre du poste</MenuItem>
            <MenuItem value="joiningDate">Date de candidature</MenuItem>
        ...
        <div className="Employees">
          ...
          <TableContainer component={Paper}>
            <Table className="ApplicationTable">
              <TableHead>
                <TableRow>
                  <TableCell align="right">Nom du candidat</TableCell>
                  <TableCell align="right">Date de candidature</TableCell>
                  <TableCell align="right">Type de poste</TableCell>
                  <TableCell align="right">Titre du poste</TableCell>
                  <TableCell align="right">Noter</TableCell>
