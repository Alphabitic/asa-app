  ...
  return (
    <>
      ...
      <div className="Profile">
        ...
        <h1 style={{ flexGrow: 1, color:'black', fontSize:"25px" }}>Pro<span style={{ color:'#7C0D0D' }}>fil</span></h1>
          <br />
          ...
          <Button
            ...
            style={{ marginRight: 20, marginBottom: 160,   backgroundColor: "black", }}
          >
            Mettre à jour
          </Button>
          <Button
            ...
            style={{ marginRight: 20, marginBottom: 160,   backgroundColor: "#7C0D0D", }}
          >
            Annuler
          </Button>
          <br />
